...
const BASE_URL = "https://fiveminforecast.lovable.app";
    ...
    handlers: {
      GET: async () => {
        const entries: SitemapEntry[] = [
          ...
          { path: "/pipeline", changefreq: "weekly", priority: "0.9" },
          ...
          { path: "/blog/how-to-create-a-sales-forecast", changefreq: "monthly", priority: "0.7" },
        ];
